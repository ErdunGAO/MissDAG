...
def produce_NA(X, p_miss, mecha="mcar", opt=None, p_obs=None, q=None):
    ...
    return X_nas.numpy().astype(np.float32), (~mask).numpy().astype(bool)
...
def create_mar_mask(X, miss_percent=0.1):
    raise NotImplementedError("Function create_mar_mask has not been implemented.")


def create_mnar_mask(X, miss_percent=0.1):
    raise NotImplementedError("Function create_mnar_mask has not been implemented.")